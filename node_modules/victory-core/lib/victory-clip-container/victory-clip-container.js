...
var VictoryClipContainer = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryClipContainer, [{
    ...
    value: function renderClippedGroup(props, clipId) {
      ...
      return /*#__PURE__*/_react.default.cloneElement(groupComponent, _objectSpread(_objectSpread({}, groupProps), {}, {
        tabIndex: tabIndex
      }, userProps), [clipComponent].concat(_toConsumableArray(_react.default.Children.toArray(children))));
    }
  }, {
    key: "renderGroup",
    value: function renderGroup(props) {
      var style = props.style,
          ...
          groupComponent = props.groupComponent,
          tabIndex = props.tabIndex;
      return /*#__PURE__*/_react.default.cloneElement(groupComponent, (0, _assign2.default)({
        className: className,
        style: style,
        transform: transform,
    ...
    value: function renderClipComponent(props, clipId) {
      ...
      return /*#__PURE__*/_react.default.cloneElement(clipPathComponent, (0, _assign2.default)({
...
_defineProperty(VictoryClipContainer, "defaultProps", {
  circleComponent: /*#__PURE__*/_react.default.createElement(_circle.default, null),
  rectComponent: /*#__PURE__*/_react.default.createElement(_rect.default, null),
  clipPathComponent: /*#__PURE__*/_react.default.createElement(_clipPath.default, null),
