...
var VictoryLegend = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VictoryLegend, [{
    ...
    value: function renderChildren(props) {
      ...
      var borderComponent = /*#__PURE__*/_react.default.cloneElement(props.borderComponent, borderProps);

      if (title) {
        var titleProps = this.getComponentProps(props.title, "title", "all");

        var titleComponent = /*#__PURE__*/_react.default.cloneElement(props.titleComponent, titleProps);
