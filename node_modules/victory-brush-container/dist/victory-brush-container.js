...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_objectSpread(_objectSpread({}, Helpers), {}, {
...
/* harmony import */ var _brush_helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./brush-helpers */ "./brush-helpers.js");
...
var brushContainerMixin = function (base) {
  ...
  return _class = /*#__PURE__*/function (_base) {
    ...
    _createClass(VictoryBrushContainer, [{
      ...
      value: function getHandles(props, domain) {
        var handleWidth = props.handleWidth,
            ...
            name = props.name;
        var domainBox = _brush_helpers__WEBPACK_IMPORTED_MODULE_4__["default"].getDomainBox(props, domain);
        var x1 = domainBox.x1,
            x2 = domainBox.x2,
            y1 = domainBox.y1,
            y2 = domainBox.y2;

        var _BrushHelpers$getHand = _brush_helpers__WEBPACK_IMPORTED_MODULE_4__["default"].getHandles(props, domainBox),
  ...
  }(base), _defineProperty(_class, "displayName", "VictoryBrushContainer"), _defineProperty(_class, "propTypes", _objectSpread(_objectSpread({}, victory_core__WEBPACK_IMPORTED_MODULE_6__["default"].propTypes), {}, {
    ...
    allowDraw: true,
    allowResize: true,
    brushComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__["default"], null),
    brushStyle: {
      stroke: "transparent",
      fill: "black",
      fillOpacity: 0.1
    },
    handleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__["default"], null),
    handleStyle: {
      stroke: "transparent",
      fill: "transparent"
    },
    ...
    return [{
      ...
      eventHandlers: {
        onMouseDown: function (evt, targetProps) {
          return props.disable ? {} : _brush_helpers__WEBPACK_IMPORTED_MODULE_4__["default"].onMouseDown(evt, targetProps);
        },
        onTouchStart: function (evt, targetProps) {
          return props.disable ? {} : _brush_helpers__WEBPACK_IMPORTED_MODULE_4__["default"].onMouseDown(evt, targetProps);
        },
        onGlobalMouseMove: function (evt, targetProps) {
          return props.disable || !targetProps.isPanning && !targetProps.isSelecting ? {} : _brush_helpers__WEBPACK_IMPORTED_MODULE_4__["default"].onGlobalMouseMove(evt, targetProps);
        },
        onGlobalTouchMove: function (evt, targetProps) {
          return props.disable || !targetProps.isPanning && !targetProps.isSelecting ? {} : _brush_helpers__WEBPACK_IMPORTED_MODULE_4__["default"].onGlobalMouseMove(evt, targetProps);
        },
        onGlobalMouseUp: function (evt, targetProps) {
          return props.disable ? {} : _brush_helpers__WEBPACK_IMPORTED_MODULE_4__["default"].onGlobalMouseUp(evt, targetProps);
        },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (brushContainerMixin(victory_core__WEBPACK_IMPORTED_MODULE_6__["default"]));
