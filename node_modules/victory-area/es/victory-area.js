...
_defineProperty(VictoryArea, "propTypes", _objectSpread(_objectSpread(_objectSpread({}, CommonProps.baseProps), CommonProps.dataProps), {}, {
...
_defineProperty(VictoryArea, "defaultTransitions", DefaultTransitions.continuousTransitions());

_defineProperty(VictoryArea, "defaultPolarTransitions", DefaultTransitions.continuousPolarTransitions());

_defineProperty(VictoryArea, "getDomain", Domain.getDomainWithZero);

_defineProperty(VictoryArea, "getData", Data.getData);
