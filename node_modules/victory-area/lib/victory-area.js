...
_defineProperty(VictoryArea, "animationWhitelist", ["data", "domain", "height", "padding", "style", "width"]);

_defineProperty(VictoryArea, "propTypes", _objectSpread(_objectSpread(_objectSpread({}, _victoryCore.CommonProps.baseProps), _victoryCore.CommonProps.dataProps), {}, {
...
_defineProperty(VictoryArea, "defaultProps", {
...
_defineProperty(VictoryArea, "displayName", "VictoryArea");

_defineProperty(VictoryArea, "role", "area");

_defineProperty(VictoryArea, "continuous", true);

_defineProperty(VictoryArea, "defaultTransitions", _victoryCore.DefaultTransitions.continuousTransitions());

_defineProperty(VictoryArea, "defaultPolarTransitions", _victoryCore.DefaultTransitions.continuousPolarTransitions());

_defineProperty(VictoryArea, "getDomain", _victoryCore.Domain.getDomainWithZero);

_defineProperty(VictoryArea, "getData", _victoryCore.Data.getData);

_defineProperty(VictoryArea, "getBaseProps", function (props) {
  return (0, _helperMethods.getBaseProps)(props, fallbackProps);
});

_defineProperty(VictoryArea, "expectedComponents", ["dataComponent", "labelComponent", "groupComponent", "containerComponent"]);
