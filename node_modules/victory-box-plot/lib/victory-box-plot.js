...
_defineProperty(VictoryBoxPlot, "defaultTransitions", _victoryCore.DefaultTransitions.discreteTransitions());

_defineProperty(VictoryBoxPlot, "propTypes", _objectSpread(_objectSpread(_objectSpread({}, _victoryCore.CommonProps.baseProps), _victoryCore.CommonProps.dataProps), {}, {
...
_defineProperty(VictoryBoxPlot, "getDomain", _helperMethods.getDomain);

_defineProperty(VictoryBoxPlot, "getData", _helperMethods.getData);
