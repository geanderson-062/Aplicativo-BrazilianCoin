...
_defineProperty(VictoryCandlestick, "defaultTransitions", _victoryCore.DefaultTransitions.discreteTransitions());

_defineProperty(VictoryCandlestick, "propTypes", _objectSpread(_objectSpread(_objectSpread({}, _victoryCore.CommonProps.baseProps), _victoryCore.CommonProps.dataProps), {}, {
...
_defineProperty(VictoryCandlestick, "getDomain", _helperMethods.getDomain);

_defineProperty(VictoryCandlestick, "getData", _helperMethods.getData);
